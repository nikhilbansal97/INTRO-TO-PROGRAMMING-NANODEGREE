...
<head>
    ...
    <style type="text/css" media="screen">
        body {
            padding-top: 80px;
            background-image:url("http://wallpapercave.com/wp/jXs1GVK.jpg");
      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="fresh_tomatoes.html" style="font-size:50px;font-family:'Caveat Brush'">Fresh Tomatoes</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-6 col-lg-3 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    <img src="{poster_image_url}" alt="{image_alt}" width="220" height="342">
    <h2>{movie_title}</h2>
    <h4>{movie_genre}</h4>
</div>
'''
